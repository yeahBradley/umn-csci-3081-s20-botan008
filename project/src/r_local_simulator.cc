...
bool rLocalSimulator::Start() {
  ...
  rPassengerGenerator * CC_EB_generator =
    new rPassengerGenerator(CC_EB_probs, CC_EB_stops_list);
  rPassengerGenerator * CC_WB_generator =
    new rPassengerGenerator(CC_WB_probs, CC_WB_stops_list);
